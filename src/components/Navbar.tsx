  ...
  return (
    <nav className="fixed flex items-center w-full h-16 top-0 left-0 right-0 z-50 bg-stone-50/90 backdrop-blur-sm border-b border-stone-200">
      <Container className="flex w-full justify-between items-center">
        <h2 className="text-base lg:text-lg font-semibold text-stone-800">
          Giovanna Prasser
        </h2>
        <div className="hidden md:flex items-start gap-8">
          {sections.map((item) => (
            <button
              ...
              className={`text-xs lg:text-sm cursor-pointer transition-all duration-200 linear ${
        ...
        <Button
          ...
          className="bg-primary hover:bg-primary/80 text-white px-6 py-2  text-xs lg:text-sm rounded-full">
          Say hello
        </Button>
      </Container>
    </nav>
